...
let myFriendNames: string[] = ['Tariq Sheikh', 'Ansab Khan', 'Hasnain Shahid', 'Zayan Shaikh', 'Kashan Kashif', 'Hasnain raza'];
...
let message = " You are my Best Friend in the world because you listen carefully and understand my feelings.";
